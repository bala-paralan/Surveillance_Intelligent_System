      ...
      <div style={{ maxWidth: 380, width: '100%' }}>
        ...
        <div className="col gap-16">
          <div className="field">
            ...
            <input className="input" placeholder="e.g. m.rivera" defaultValue="m.rivera" />
          </div>
          <div className="field">
          ...
          <div className="field">
            ...
            <span className="hint">A physical key is required for all sessions.</span>
          </div>
          ...
          <button
            ...
            onClick={onLogin}
          >
            Sign in to Sector NW-04 <Icon name="chevr" />
          </button>
